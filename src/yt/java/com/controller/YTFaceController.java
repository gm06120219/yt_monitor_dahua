...
public class YTFaceController extends YTController {

	private static Logger _logger = LogManager.getLogger();
	private YTServiceView _view;
	private YTFaceService _service;
	private final String DEVICE_TYPE = "face";
	
	public YTFaceController(YTMainView ui) {
		// view 
		_view = ui.GetFaceViewer();
		
		// model
		_service = new YTFaceService(_view);
		...
		_view.SetDetailOnClick(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				_logger.info("face service detail button onclick");
				new YTFaceDetailController(_service);
			}
		});
		...
		_view.SetConfigOnClick(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				_logger.info("face service config button onclick");
				new YTFaceConfController(_service);
			}
		});
	}
