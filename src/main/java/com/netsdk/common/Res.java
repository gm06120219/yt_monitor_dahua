...
public final class Res {
	...
	public String getSoftware() {
		return bundle.getString("SOFTWARE_NAME");
	}
	...
	public String getAutoRun() {
		return bundle.getString("AUTO_RUN");
	}
	...
	public String getLogLevel() {
		return bundle.getString("LOG_LEVEL");
	}

	public String getLogAutoUpload() {
		return bundle.getString("LOG_AUTO_UPLOAD");
	}

	public String getLogUpload() {
		return bundle.getString("LOG_UPLOAD");
	}

	public String getServiceList() {
		return bundle.getString("SERVICE_LIST");
	}
